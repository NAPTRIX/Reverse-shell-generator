...
\______   \ _______  __ ___________   ____  /   _____/|  |__   ____ |  | |  |  
 |       _// __ \  \/ // __ \_  __ \_/ __ \ \_____  \ |  |  \_/ __ \|  | |  |  
 |    |   \  ___/\   /\  ___/|  | \/\  ___/ /        \|   Y  \  ___/|  |_|  |__
 |____|_  /\___  >\_/  \___  >__|    \___  >_______  /|___|  /\___  >____/____/
        \/     \/          \/            \/        \/      \/     \/           
         ________                                   __                         
...
def exit_program():
    print('\n' + success.safe_substitute(text='Adios, frien :D.'))
    exit(0)
    ...
    for interface in interfaces():
        try:
            ...
            if ip_address != '127.0.0.1':
                options[ip_address] = ip_address + ' on the interface: ' + interface
        except KeyError:
            pass
